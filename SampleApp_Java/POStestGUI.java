...
public class POStestGUI extends JPanel
...
//        tabbedPane.addTab("RemoteOrderDisplay", null, remoteOrderDisplayPanel.make(), "RemoteOrderDisplay");
        ...
        scannerPanel.defaultLogicalName = devPanel.defaultLogicalScanner;
...
//        tabbedPane.addTab("ToneIndicator", null, toneIndicatorPanel.make(), "ToneIndicator");
	...
	/** 
	 * Commented the following two lines as there are two 'Exit' buttons already present inside scanner and scale tabs
	*/
